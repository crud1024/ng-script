class TreeTableManager {
  ...
  handleMoveUp(table, row) {
    ...
    if (this.isRootNode(selectedRow)) {
      ...
      // 在克隆后的树中，通过 s_tree_id 查找目标节点的父级和索引
