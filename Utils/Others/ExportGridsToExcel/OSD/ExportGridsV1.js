...
// 方式1: 使用默认配置（默认 log_type 作为背景色字段，marks 作为标记字段）
// const exporter = new ExcelExporter();
// await exporter.export(designData, resultData);

// 方式2: 自定义背景色字段和标记字段（例如您的数据可能使用 'row_type' 和 'mark_list'）
// const exporter = new ExcelExporter({
//     fileName: '我的测算报表',
//     mode: 'leafSpan',
//     // 自定义行背景色配置
//     rowBackgroundConfig: {
//         fieldName: 'row_type',           // 使用 row_type 字段而不是 log_type
//         colorMap: {
//             1: 'FFFFF0B3',               // 浅黄色
//             2: 'FFB3DAFF',               // 浅蓝色
//             3: 'FFD9FFCC',               // 浅绿色
//             'error': 'FFFFB3B3'          // 支持任意值类型
//         }
//     },
//     // 自定义单元格标记配置
//     markCellConfig: {
//         fieldName: 'mark_list',          // 使用 mark_list 字段而不是 marks
//         alternateFieldName: 'MarkList',  // 备选字段名
//         markColor: 'FFFF4D4F'            // 红色
//     },
//     headerStyle: {
...
// 方式3: 完全动态配置 - 如果字段名和颜色值都来自后端配置
// const dynamicConfig = {
//     rowBackgroundConfig: {
//         fieldName: responseData.bgFieldName,      // 从后端获取
//         colorMap: responseData.colorMapping       // 从后端获取
//     },
//     markCellConfig: {
//         fieldName: responseData.markFieldName,    // 从后端获取
//         markColor: responseData.markColor         // 从后端获取
//     }
// };
// const exporter = new ExcelExporter(dynamicConfig);
// await exporter.export(designData, resultData);
