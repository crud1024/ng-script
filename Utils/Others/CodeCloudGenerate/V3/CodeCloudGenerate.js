...
class DataChangeComparator {
  ...
  updateTexts(texts) {
    ...
    if (this._currentDisplayState === "loading") {
      ...
      this._showEmpty();
    } else if (this._currentDisplayState === "error") {
      // 错误状态需要保留原错误消息，所以不自动刷新
...
//   texts: {
//     processingTitle: "数据迁移中",
//     processingSubtitle: "正在处理表结构迁移",
//     processingAnimationText: "迁移进行中，请稍候...",
//     loadingTitle: "加载组件中",
//     loadingSubtitle: "请稍等",
//     emptyTitle: "暂无数据",
...
//   processingAnimationText: "自定义动画文字"
// });
