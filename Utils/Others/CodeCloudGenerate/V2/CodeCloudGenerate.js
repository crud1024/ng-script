...
class DataChangeComparator {
   ...
   *   loadingAnimationText: "数据同步中，请稍候..."
   * });
   */
  updateTexts(texts) {
    this.config.texts = {
  ...
  _showProcessing() {
    ...
    const { processingTitle, processingSubtitle, loadingAnimationText } =
      this.config.texts;
...
">
  ...
  <p style="margin-top: 16px; font-size: 12px; color: #999;">
    ${this._escapeHtml(loadingAnimationText)}
  </p>
</div>
<style>
  @keyframes loading {
...
`;
  ...
  _showError(message) {
    ...
    const { errorTitle, errorSubtitle } = this.config.texts;
...
">
  ...
  <p style="margin: 0; font-size: 14px; line-height: 1.5; max-width: 300px; color: #666;">
...
// 方式1：初始化时配置文本
// const comparator = new DataChangeComparator('container-id', {
//   texts: {
//     processingTitle: "数据同步中",
//     processingSubtitle: "正在同步表结构数据",
//     loadingAnimationText: "同步中，请稍候...",
//     loadingTitle: "加载组件中",
//     loadingSubtitle: "请稍等",
//     emptyTitle: "暂无数据",
//     emptySubtitle: "请检查数据源配置",
//     errorTitle: "加载出错",
//     errorSubtitle: "请刷新页面重试"
//   }
// });

// 方式2：动态更新文本配置
// comparator.updateTexts({
//   processingTitle: "自定义标题",
//   processingSubtitle: "自定义副标题",
//   loadingAnimationText: "自定义动画文字"
// });

// 方式3：手动显示处理状态
// comparator.showProcessing();
